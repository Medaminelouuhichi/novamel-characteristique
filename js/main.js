(function ($) {
  ...
  var clStatCount2 = function () {
    var statSection2 = $(".about-stats"),stats2 = $(".stats__count2");

    statSection2.waypoint({
      handler: function (direction) {
        if (direction === "down") {
          stats2.each(function () {
            var $this = $(this);
